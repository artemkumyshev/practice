...
const citiesList = ["Москва", "Санкт-Петербург", "Ростов-на-Дону", "Краснодар"];

const LocationCity = ({ city = "Москва" }) => {
  ...
  return (
    <div className={styles.LocationCity}>
      <div
        className={styles.LocationCity__button}
        onClick={() => setIsOpen(!isOpen)}
      >
        <svg
          className={styles.LocationCity__icon}
          width="20"
          height="20"
          viewBox="0 0 20 20"
          fill="none"
        ...
        <span className={styles.LocationCity__title}>{currentCity}</span>
        <svg
          width="12"
          height="12"
          viewBox="0 0 12 12"
      ...
      {isOpen && (
        <div className={styles.LocationCity__select}>
          {citiesList.map((option, i) => (
            <div
              key={i}
              className={styles.LocationCity__select}
              onClick={() => {
